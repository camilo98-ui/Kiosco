    ...
    <div className="min-h-screen" style={{ background: "#FFFAF9" }}>
      ...
      <div
        ...
        <div className="flex items-center gap-2" style={{ height: 64, paddingLeft: 0, paddingRight: 12, justifyContent: "space-between" }}>
          <button onClick={handleLogoClick} style={{ background: "none", border: "none", cursor: "pointer", padding: 0, display: "flex", alignItems: "center", marginTop: 8, outline: "none" }}>
            <img src="https://media.base44.com/images/public/69cc99522394d529d2756aa4/d29919a1a_Logo_poopsy-removebg-preview.png" alt="Popsy" style={{ height: 384, objectFit: "contain", filter: "brightness(0) invert(1)" }} />
          </button>
