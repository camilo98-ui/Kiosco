...
export default function Menu() {
  ...
  const STORES_WITH_COOKIE_JAAR = ["COLINA", "PLAZA IMPERIAL 2", "VIVA TUNJA", "FONTANAR"];
  const hasCoookieJaar = STORES_WITH_COOKIE_JAAR.includes(store?.name);
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#FFF5F7" }}>
      {/* ── HEADER ── */}
      <div
      ...
      {/* ── CONTENIDO ── */}
      <div style={{ paddingBottom: 120, background: "#FFF5F7", flex: 1 }}>
