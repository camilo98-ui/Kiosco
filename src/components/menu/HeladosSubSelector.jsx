...
const ESPECIALES_EXTRA = [
  {
    ...
    price: 29900,
    image_url: "https://media.base44.com/images/public/69cc99522394d529d2756aa4/f61c80b47_image.png",
  ...
  },
  {
    ...
    name: "Banana Split",
    price: 29900,
    image_url: "https://media.base44.com/images/public/69cc99522394d529d2756aa4/2f85afe20_image.png",
    category: "especialidades",
    is_available: true,
    tag: "recomendado",
  },
  ...
  },
  {
    ...
    name: "Sundae 1 Sabor",
    price: 18900,
    image_url: "https://media.base44.com/images/public/69cc99522394d529d2756aa4/2df60753e_Sundae1sabor10900.png",
    category: "especialidades",
    is_available: true,
    tag: "none",
  },
  {
    ...
    price: 22900,
    image_url: "https://media.base44.com/images/public/69cc99522394d529d2756aa4/4ec8da0eb_Sundae2sabores14900.png",
    category: "especialidades",
    is_available: true,
    tag: "none",
  },
    ...
    <div style={{ marginTop: 16 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
        {TENDENCIA_GRID.map((p, i) => (
          <GridCard2x2 key={p.id} product={p} badge={GRID_BADGES[i] || null} onAdd={onAdd} imgPosition={p.id === "maxicono-grid" ? "center 60%" : "center 10%"} />
        ))}
      </div>
