...
export default function MalteadaCustomizer12oz({ product, open, onClose, onAdd }) {
  ...
  const handleConfirm = () => {
    ...
    onAdd({ ...product, price: total, name: `${product.name} ${sabor}` }, notes);
  ...
  return (
    <Sheet open={open} onOpenChange={onClose}>
      ...
      >
        ...
        <AccordionSection
          title="Elige Sabor De Helado"
          required
          open={openSection === "sabor"}
          onToggle={() => toggle("sabor")}
        >
          <p style={{ fontSize: 11, color: "#BBA8B0", padding: "0 16px 6px" }}>Selecciona 1 opción</p>
