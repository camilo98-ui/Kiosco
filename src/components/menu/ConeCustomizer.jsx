...
export default function ConeCustomizer({ product, open, onClose, onAdd }) {
    ...
    <Sheet open={open} onOpenChange={onClose}>
      ...
      >
        <div style={{ padding: "20px 16px 12px", borderBottom: "1px solid #F0E4EA" }}>
          <p style={{ fontSize: 11, color: "#BBA8B0", margin: "0 0 4px", fontWeight: 600 }}>Personaliza tu cono</p>
